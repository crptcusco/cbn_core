...
def run_audit(input_path: str):
    ...
    print("======================================================================")
    print("📊 REPORTE DE AUDITORÍA DE MÉTODOS DEL SOLVER - CBN_CORE")
    print("======================================================================")

    results = []

    # 1. Attractor Finding Methods
    attractor_methods = [
        "find_local_attractors_sequential",
        "find_local_attractors_brute_force_sequential",
    ...
    for m in attractor_methods:
        ...
        print(f"[{status:4}] {m:45} -> {msg}")

    # For Pairs and Fields, use a base CBN that worked (prefer brute force)
    base_cbn = CBN.from_json(input_path)
    base_cbn.find_local_attractors_brute_force_sequential()

    print("-" * 70)
    for m in pairs_methods:
        # Reset compatible pairs
    ...
    # Parity Check
    print("======================================================================")
    print("🔍 VERIFICACIÓN DE PARIDAD CIENTÍFICA")
    print("======================================================================")
    ...
    def check_parity(group_name, methods_in_group):
        ...
        if len(set(counts)) > 1:
            print(f"🚨 ALERT: Divergence in {group_name}!")

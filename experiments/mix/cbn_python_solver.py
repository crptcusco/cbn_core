...
def main():
    ...
    parser.add_argument('--output', type=str, required=True, help='Output dynamics JSON file')
    ...
    print(f"[OK] Python simulation completed in {duration_ms:.2f} ms. Results saved to {args.output}")

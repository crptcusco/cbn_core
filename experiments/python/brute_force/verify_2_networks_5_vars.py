    ...
    for net in networks:
        ...
        if out_signals:
            ...
            for s in out_signals:
                print(
                    f"    Signal {s.index_variable} (Index {s.index}): {s.coupling_function} using vars {s.l_output_variables}"
                )
        ...
        for scene_obj in net.local_scenes:
            ...
            print(
                f"    Scene [{scene_str}]: {len(scene_obj.l_attractors)} attractors found"
            )
